...
<nav class="#37474f blue-grey darken-3" role="navigation">
  ...
  <div class="section no-pad-bot" id="index-banner">
	...
	<center><h2 style="font-family:Comic Sans MS">List Of Employees</h2></center>
  <ul class="collection">
<?php
...
include_once "func.php";
	...
	$obj= new func();
    $result=$obj->lis($_SESSION['user']['canteen']);
	if($result==false){
	  ...
	  echo "<span class='title' style='font-size:20px;margin-left:0em'>Name: {$row['eName']}</span>"; 
      		  echo "</br>";
	  echo "<span class='title' style='font-size:20px;margin-left:0em'>Email: {$row['email']}</span>"; 
	  		  echo "</br>";
	  
	  echo "</br>";
	  echo '<a href="editemp.php?eName='.$row['eName'].'&email='.$row['email'].'&eno='.$row['Id'].'"><button id="btn_menu" class="btn waves-effect waves-teal" style="margin-left:2em">Edit</button></a>';
	 echo "<br>";
	 	 echo "<br>";

	  echo '<button name="btn-upload" class=" btn waves-effect waves-teal delete" id='.$row['Id'].'  style="margin-left:2em">Delete</button>';
	  echo "</li>";
